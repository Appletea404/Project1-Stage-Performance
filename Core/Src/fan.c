...
//void Fan()
//{
//    // 1. 전원 버튼 처리 (신호 발생 시 딱 한 번만 실행)
//    if (Flag1)
//    {
//        Flag1 = 0; // 신호 확인 즉시 리셋 (매우 중요!)
//
//        if (isPowerOn) {
//            Save = Count;  // 현재 속도 저장
//            Count = 0;     // 출력은 0
//            isPowerOn = 0; // 전원 상태 Off
//        } else {
//            Count = (Save >= COUNT_MIN) ? Save : COUNT_MIN; // 저장된 속도 복구
//            isPowerOn = 1; // 전원 상태 On
//        }
//    }
//
//    // 2. 속도 조절 (전원이 켜져 있을 때만 동작)
...
//        }
//    }
//    else // 전원이 꺼져 있을 때 들어온 신호는 그냥 지우기
//    {
//        Flag2 = 0;
//        Flag3 = 0;
//    }
...
//    LED_Write(FND_NUMBER[Count]);
//    // 전원 상태에 따라 PWM 출력 결정
//    TIM2->CCR1 = isPowerOn ? FAN_SPEED[Count] : 0;
//}
...
//		{
//			Flag1 = !Flag1;
//			Count = (Save >= COUNT_MIN) ? Save : COUNT_MIN;
//		}
//
//	}
//	if (Flag2) {
...
//
//	LED_Write(FND_NUMBER[Count]);
//	TIM2->CCR1 = Flag1 ? FAN_SPEED[Count] : 0;
//
//}
